 ...
 * Redis工具
 * 
 * @package com.github.boonya.redis.JedisUtil
 * @date 2017年3月17日 上午10:20:40
 * @author pengjunlin
 * @comment
 * @update
 */
public class JedisUtil {
	...
	static {
		...
		// redis未设置了密码：
		jedisPool = new JedisPool(config, "192.168.234.129", 6379, expire);
	}
	...
	public static void main(String[] args) {
		...
		strings.set("boonya", "boonya");

		System.out.println("-----" + strings.get("boonya"));
